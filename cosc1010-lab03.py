...
# Lab 03 
# Lab Section: 02
# Sources, people worked with, help given to: https://www.w3schools.com/python/ref_list_append.asp, https://www.w3schools.com/python/ref_list_insert.asp
...
print(f"{sorted(states)} - sorted alphabetically")
print(f"{states} - unsorted")

#Permanently sort your list in reverse order, printing it out
states.sort(reverse = True)
print(f"{states} - permenantly sorted reverse alphabetically")

#Using the reverse method reverse the list and print it
states.reverse()
print(f"{states} - reversed using reverse()")
